        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="card text-center border-success">
                        <div class="card-header bg-success text-light">
                            <h5 class="card-title">Calculo 7:00 a 9:00</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="card text-center border-info">
                        <div class="card-header bg-info text-light">
                            <h5 class="card-title">Programacion 9:00 a 11:00</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="modal-body text-center">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <!-- Title-->
                                <h2 class="portfolio-modal-title text-warning mb-0">Calculo</h2>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                        ...
                                        <script type="text/x-templete" id="main-page">
                                                        <div>
                                                            ...
                                                            <div v-show="percent>=80">
                                                                <h5 class="text-success"> </br> </br> Estudiante atento</br> Lorem ipsum dolor sit amet, consectetur adipisicing elit.Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</h5>
                                                            </div>
                                                          
                                                            <div v-show="percent<80 && percent>=50">
                                                                <h5> </br> </br>Estudiante un poco distraido</br> Lorem ipsum dolor sit amet, consectetur adipisicing elit.Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</h5>
                                                            </div>

                                                            <div v-show="percent<50">
                                                                <h5> </br> </br>Estudiante muy distraido </br> Lorem ipsum dolor sit amet, consectetur adipisicing elit.Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</h5>
                                                            </div>                                       
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <div class="container">
                        <!-- Title-->
                        <h2 class="portfolio-modal-title text-warning mb-0">Programacion</h2>
                        <!-- Icon Divider-->
                        <div class="divider-custom">
                            <div class="divider-custom-line"></div>
                            <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <script type="text/x-templete" id="main-page">
                                                <div>
                                                    ...
                                                    <button v-show="percent<80" id="tipclase2"><i class="fas fa-fw"></i>Tip</button>
                                                    ...
                                                    <div v-show="percent>=80">
                                                        <h5> </br> </br> Mensaje 0</br> Lorem ipsum dolor sit amet, consectetur adipisicing elit.Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</h5>
                                                    </div>
                                                  
                                                    <div v-show="percent<80 && percent>=50">
                                                        <h5> </br> </br> Mensaje 1</br> Lorem ipsum dolor sit amet, consectetur adipisicing elit.Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</h5>
                                                    </div>

                                                    <div v-show="percent<50">
                                                        <h5> </br> </br> Mensaje 2 </br> Lorem ipsum dolor sit amet, consectetur adipisicing elit.Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</h5>
                                                    </div>  
